...
/*    public static String base64_url_decode(String data) {
    ...
    public static String base64_url_decode(String str) throws UnsupportedEncodingException {
        return new String((base64_url_decode_byte(str)), StandardCharsets.ISO_8859_1);
    }

    public static byte[] base64_url_decode_byte(String str) {
        str = str.replace(" ", "");
    ...
    static byte[] decodeHexString(String s) {
