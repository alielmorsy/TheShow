...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
    ...
    public void updateList(List<? extends ExpandableGroup> groups) {
        ...
        if (expandableList == null) {
            ...
            boolean[] expandedGroupIndexes = new boolean[groups.size()];
            for (int i = 0; i < groups.size(); i++) {
                expandedGroupIndexes[i] = false;
            }
            expandableList.expandedGroupIndexes = expandedGroupIndexes;
        }
    ...
    public int getItemCount() {
        if (expandableList.groups.size() == 0)
            return 0;
     ...
     * com.thoughtbot.expandablerecyclerview.ExpandableRecyclerViewAdapter} is attached to.
     * <p>
     ...
     * {@link com.thoughtbot.expandablerecyclerview.ExpandableRecyclerViewAdapter} is attached to.
     * <p>
     *
     ...
     *
     * @param viewType an int returned by {@link com.thoughtbot.expandablerecyclerview.ExpandableRecyclerViewAdapter#getItemViewType(int)}
