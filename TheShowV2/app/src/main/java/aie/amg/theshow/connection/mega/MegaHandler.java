...
public class MegaHandler {
    public static final String[] emails = new String[]{
            "rutrekerti@yevme.com",
            "mefyehispu@yevme.com",
            "jamlisirto@yevme.com",
            "bovive2853@provamail.com",
            "venafo2749@mailezee.com",
    };
    ...
    public String createLink(String url) {
        ...
        try {
            ...
            String file_name = new JSONObject(attribs.substring(4)).getString("n");
