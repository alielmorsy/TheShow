...
$columns = array(
    ...
    array('db' => $table=="series"? 'imageURL' :'imageUrl', 'dt' => 'image', "formatter" => function ($d, $row) {
        return "<img src=\"../../images/$d.jpg\" alt=\"\" class='cover'>";
    }),
...
$sql_details = array(
    'user' => 'id12905917_theshow',
    'pass' => 'ALi123456789',
    'db' => 'id12905917_theshow',
    'host' => 'localhost'
);
